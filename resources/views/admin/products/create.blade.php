...
@section('title', 'Tambah Produk - Admin ReUse Market')
...
<div class="bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-4xl font-black">Tambah Produk Baru</h1>
    </div>
</div>
        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="details" required rows="4" maxlength="1000"
                    ...
                    placeholder="Jelaskan kondisi, fitur, dan detail produk...">{{ old('details') }}</textarea>
            ...
            <div>
                ...
                <div class="space-y-2">
                    <label class="flex items-center p-3 border-2 border-gray-300 rounded-xl cursor-pointer hover:border-purple-500 transition @error('condition') border-red-500 @enderror">
                        <input type="radio" name="condition" value="like_new" {{ old('condition') == 'like_new' ? 'checked' : '' }} required class="w-4 h-4 text-purple-600">
                    ...
                    <label class="flex items-center p-3 border-2 border-gray-300 rounded-xl cursor-pointer hover:border-purple-500 transition">
                        <input type="radio" name="condition" value="good" {{ old('condition') == 'good' ? 'checked' : '' }} class="w-4 h-4 text-purple-600">
                        <span class="ml-3 font-semibold text-gray-800">Bagus</span>
                    </label>
                    <label class="flex items-center p-3 border-2 border-gray-300 rounded-xl cursor-pointer hover:border-purple-500 transition">
                        <input type="radio" name="condition" value="fair" {{ old('condition') == 'fair' ? 'checked' : '' }} class="w-4 h-4 text-purple-600">
            ...
            <div class="border-2 border-dashed border-purple-300 rounded-2xl p-8">
                <h3 class="text-lg font-bold text-gray-800 mb-6">
                    <i class="fas fa-image text-purple-600 mr-2"></i> Unggah Gambar Produk
                </h3>

                <!-- Gambar 1 (Required) -->
                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        <i class="fas fa-camera text-purple-600 mr-1"></i> Gambar Utama (Required) *
                    </label>
                    <div class="flex items-center justify-center w-full">
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-purple-300 rounded-xl cursor-pointer hover:bg-purple-50 transition">
                            ...
                            <input type="file" name="image_01" accept="image/*" required class="hidden" onchange="updateImagePreview(this, 'preview_01')">
                        </label>
                    </div>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        <i class="fas fa-camera text-gray-400 mr-1"></i> Gambar Tambahan 1 (Optional)
                    </label>
                    <div class="flex items-center justify-center w-full">
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        <i class="fas fa-camera text-gray-400 mr-1"></i> Gambar Tambahan 2 (Optional)
                    </label>
                    <div class="flex items-center justify-center w-full">
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:bg-gray-50 transition">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
